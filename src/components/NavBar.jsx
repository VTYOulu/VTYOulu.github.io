  ...
  return (
    <div className="bg-neutral-700 py-4 px-6 flex items-center justify-center">
      <div className="text-neutral-200 text-xl flex flex-wrap items-center justify-between py-2">
        ...
        <NavButton name={"Toiminta"} secondary={"Etusivu"} items={["Hallitus", "Toimintakertomus", "Säännöt"]} onItemClick={props.onItemClick}></NavButton>
        <NavButton name={"Tapahtumat"} secondary={"Etusivu"}  onItemClick={props.onItemClick}></NavButton>
